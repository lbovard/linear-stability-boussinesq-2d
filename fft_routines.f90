...
contains
        ...
        subroutine alloc_fft()
                ...
                funcp=fftw_alloc_complex(int(N*N,C_SIZE_T))
                ...
                uqt=fftw_alloc_complex(int(N*N,C_SIZE_T))
                vqt=fftw_alloc_complex(int(N*N,C_SIZE_T))
                wqt=fftw_alloc_complex(int(N*N,C_SIZE_T))
                rhoq=fftw_alloc_complex(int(N*N,C_SIZE_T))
                funcq=fftw_alloc_complex(int(N*N,C_SIZE_T))
                ...
                call c_f_pointer(uqt,uu_hat_temp,[N,N])
                call c_f_pointer(vqt,vv_hat_temp,[N,N])
                call c_f_pointer(wqt,ww_hat_temp,[N,N])
                call c_f_pointer(rhoq,rho_hat,[N,N])
                call c_f_pointer(funcq,rho_hat,[N,N])
